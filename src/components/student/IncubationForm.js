...
/**
 * Reference: /reference/mast ui/Student/Incubation Apply.png
 *            /reference/mast ui/Overlay/Student Incubation Apply Submitted.png
 *
  ...
  return (
    <>
      ...
      >
        <Card padding="none" className="px-4 py-5 lg:px-8 lg:py-7">
          <div className="space-y-5">
            ...
            <FormField
              label="Team Members (App IDs)"
              name="team"
              placeholder="ATL-2024-0871, ATL-2023-0342..."
              size="responsive"
            />
      ...
      <ConfirmDialog
        ...
        description="Mihir Pawar will review your application and reach out offline. You can track its status anytime under My Application."
        primaryLabel="Got it"
      />
    </>
  )
